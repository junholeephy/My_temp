...
void VBSWW_test_LL()
{
    TFile *fout = new TFile("output_lhe_VBSWW_LL.root","RECREATE");
    TTree *treeE  = new TTree("treeE","treeE");

    TChain chain("LHEF");
    chain.Add("/Users/leejunho/Desktop/MG5_aMC_v2_6_1/bin/VBSww/LL/unweighted_events.root");
//    chain.Add("/Users/leejunho/Desktop/MG5_aMC_v2_6_1/bin/VBSww_LL/Events/run_02/unweighted_events.root");
