...
n35_infile::n35_infile(TFile *file)
{
	file_ =file;
...
vector<TH1D*> n35_infile::gethistoDATA()
{
	double perc=0;
	int is_medi;
	int i, ipp;
...
vector<TH1D*> n35_infile::gethistoMC_T()
{
	double perc=0;
	int is_medi;
	int i, ipp;
