...
//    std::vector<TRootLHEFParticle*> vSelectedGenJet;
    ...
    treeW1->Branch("W1Pt",&W1Pt,"W1Pt/D");  treeW1->Branch("W1Eta",&W1Eta,"W1Eta/D");  treeW1->Branch("W1Phi",&W1Phi,"W1Phi/D");  treeW1->Branch("W1Spin",&W1Spin,"W1Spin/D");
    treeW2->Branch("W2Pt",&W2Pt,"W2Pt/D");  treeW2->Branch("W2Eta",&W2Eta,"W2Eta/D");  treeW2->Branch("W2Phi",&W2Phi,"W2Phi/D");  treeW2->Branch("W2Spin",&W2Spin,"W2Spin/D");
    treeP1->Branch("P1Pt",&P1Pt,"P1Pt/D");  treeP1->Branch("P1Eta",&P1Eta,"P1Eta/D");  treeP1->Branch("P1Phi",&P1Phi,"P1Phi/D");  treeP1->Branch("P1Spin",&P1Spin,"P1Spin/D");
    treeP2->Branch("P2Pt",&P2Pt,"P2Pt/D");  treeP2->Branch("P2Eta",&P2Eta,"P2Eta/D");  treeP2->Branch("P2Phi",&P2Phi,"P2Phi/D");  treeP2->Branch("P2Spin",&P2Spin,"P2Spin/D");
    ...
    { 
        ...
        P1Pt = particleP1->PT;  P1Eta = particleP1->Eta;  P1Eta = particleP1->Phi;  P1Spin = particleP1->Spin;
        P2Pt = particleP2->PT;  P2Eta = particleP2->Eta;  P2Eta = particleP2->Phi;  P2Spin = particleP2->Spin;
