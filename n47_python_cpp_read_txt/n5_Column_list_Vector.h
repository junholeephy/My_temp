#ifndef _N5_COLUMN_LIST_VECTOR_H_
#define _N5_COLUMN_LIST_VECTOR_H_
...
class n5_Column_list_Vector
{
    public:
        n5_Column_list_Vector();
        void makePoints(string *x, vector<string> STF);
        vector<string *> MAKE_Column_list_Vector(string file);
};

n5_Column_list_Vector::n5_Column_list_Vector()
{
}

void n5_Column_list_Vector::makePoints(string *x, vector<string> STF)
{
...
vector<string *> n5_Column_list_Vector::MAKE_Column_list_Vector(string file)
{
    vector<string> STR;
