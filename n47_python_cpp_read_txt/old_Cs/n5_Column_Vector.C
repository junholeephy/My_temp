//root -l -q n5_Column_Vector.C\('"/Users/leejunho/Desktop/git/python3Env/group_study/project_pre/data_txt/BEIJING_Aqi/Aqi_Beijing_Holi.txt"'\)
#include <vector>
#include <iostream>
#include <fstream>
#include <cassert>
...
//vector<vector<string>> n5_Column_Vector(string file)
vector<string *> n5_Column_Vector(string file)
{
    vector<string> STR;
    n3_ROW_VECTOR* row_vector = new n3_ROW_VECTOR(&file);
    STR = row_vector->MAKE_ROW_VECTOR(&file);
    n4_ITEM_NUM_of_ROW* row_num = new n4_ITEM_NUM_of_ROW(&file);
